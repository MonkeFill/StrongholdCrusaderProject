...
public class BasicTextButton
{
    ...
    {
        Texture2D TextBackground = Content.Load<Texture2D>(Path.Combine(GlobalButtonFolder, "Text_Background"));
        Texture2D TextBackgroundHover = Content.Load<Texture2D>(Path.Combine(GlobalButtonFolder, "Text_Background_Hover"));
