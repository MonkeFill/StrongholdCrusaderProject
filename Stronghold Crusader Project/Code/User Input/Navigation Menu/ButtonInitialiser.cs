...
public static class ButtonInitaliser //Class that handles all button creating
{
    //Methods
    public static void Initalise(ButtonsManager ButtonManager, ContentManager Content, Texture2D Pixel, SpriteFont ActiveSpriteFont) //Creating all the buttons
    {
        ...
        ButtonManager.CreateButton(new IconButton("TestButton2", new Vector2(75, 10), 50, 50, Content.Load<Texture2D>("IconTest"), Input_Visible: true, Input_Stroke: 5, Input_StrokeColour: Color.GreenYellow, Input_StrokePixel: Pixel,
            Input_Background: Content.Load<Texture2D>("BackgroundTest"), Input_ActiveIcon: Content.Load<Texture2D>("ActiveTest"), Input_HoverIcon: Content.Load<Texture2D>("HoverTest"), Input_Category: "TestCategory"));
        ...
        ButtonManager.CreateButton(new TitleButton("TestButton 1", new Vector2(10, 10), 50, 50, "Button 1", 30, Color.White, ActiveSpriteFont, true, Input_Stroke: 5, Input_StrokeColour: Color.GreenYellow, Input_StrokePixel: Pixel,
            Input_Background: Content.Load<Texture2D>("BackgroundTest"), Input_ActiveColour: Color.Red, Input_Category: "TestCategory", Input_HoverColour: Color.Blue));
